...
public:
    ...
    m_parents{Forge::Tensor{parent_tensors, Forge::NodeContext{}}...}, m_child{child}, m_dispatch_key{device==Device::CPU?DispatchKey::CPU_Autodiff:DispatchKey::CUDA_Autodiff},
